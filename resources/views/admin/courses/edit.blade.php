        ...
        <form action="{{ route('admin.courses.update', $course) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                ...
                @if($course->cover_image)
                    <div class="mb-2">
                        <img src="{{ Storage::url($course->cover_image) }}" alt="Capa atual" class="h-32 w-auto rounded">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="preview_video_provider"
                            ...
                            <option value="youtube" {{ old('preview_video_provider', $course->preview_video_provider) === 'youtube' ? 'selected' : '' }}>YouTube</option>
                            <option value="vimeo" {{ old('preview_video_provider', $course->preview_video_provider) === 'vimeo' ? 'selected' : '' }}>Vimeo</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="text"
                               ...
                               value="{{ old('preview_video_id', $course->preview_video_id) }}"
