<x-admin-layout title="Editar Aula">
                    ...
                    @foreach($lesson->attachments as $attachment)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                {{-- form fora do form principal via atributo form="" --}}
                                <button type="submit"
    ...
    {{-- Forms de exclusão de anexos (fora do form principal para evitar aninhamento) --}}
    @foreach($lesson->attachments as $attachment)
        <form id="delete-attachment-{{ $attachment->id }}"
              action="{{ route('admin.lessons.attachments.destroy', $attachment) }}"
              method="POST"
              class="hidden">
            @csrf
            @method('DELETE')
