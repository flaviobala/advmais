<x-admin-layout title="Editar Grupo">
    <div class="mb-6">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900">Editar Grupo: {{ $group->name }}</h2>
        </div>
        ...
        <form action="{{ route('admin.groups.update', $group) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Slug atual: {{ $group->slug }}</p>
                @error('name')
